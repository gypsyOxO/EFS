...
import ContributionReceivedBox from "../../assets/IE/contributions/ContributionReceivedBox"
				...
				<Paper key={index} className={classes.paper}>
					...
					<Grid container spacing={3} className={classes.grid}>
						<Grid item xs={12} sm={6}>
							<Field
								name={`${contribution}.contributorFullName`}
								type="text"
						...
						<Grid item xs={12} sm={3}>
							<Field
								name={`${contribution}.dateReceived`}
								type="text"
								component={renderTextField}
								fullWidth
								label="Date Received"
						...
						<Grid item xs={12} sm={3}>
							<Field
								name={`${contribution}.amountReceived`}
								type="text"
								component={renderTextField}
								fullWidth
					...
					<Grid container spacing={3} className={classes.grid}>
						<Grid item xs={12} sm={12}>
							<Field
								name={`${contribution}.contributorAddress`}
								type="text"
								component={renderTextField}
								fullWidth
					...
					<Grid container spacing={3} className={classes.grid}>
						<Grid item xs={12} sm={12}>
							<Field
								name={`${contribution}.contributorEmployerOccupation`}
								type="text"
								component={renderTextField}
								fullWidth
...
const StepperFormFifthPage = props => {
